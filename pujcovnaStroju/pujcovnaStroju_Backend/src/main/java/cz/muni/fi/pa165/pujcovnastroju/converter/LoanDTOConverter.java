...
public class LoanDTOConverter {
	...
	public static Loan dtoToEntity(LoanDTO loanDTO) {
		...
		loan.setCustomer(SystemUserDTOConverter.dtoToEntity(loanDTO
				.getCustomer()));
		...
		loan.setLoanState(LoanStateEnumDTOConverter.dtoToEntity(loanDTO
				.getLoanState()));
		loan.setMachines(MachineDTOConverter.listToEntities(loanDTO
				.getMachines()));
		return loan;
	}
	...
	public static LoanDTO entityToDTO(Loan loan) {
		...
		loanDTO.setCustomer(SystemUserDTOConverter.entityToDTO(loan
				.getCustomer()));
